...
[![Build Status](https://github.com/shh1v/imc-prosperity-4-backtester/workflows/Build/badge.svg)](https://github.com/shh1v/imc-prosperity-4-backtester/actions/workflows/build.yml)

This repository contains a backtester [IMC Prosperity 4](https://prosperity.imc.com/) algorithms, heavily adapted version of [@jmerle's](https://github.com/jmerle) [backtester for Prosperity 3](https://github.com/jmerle/imc-prosperity-3-backtester) with the following improvements:

1. Generates logs in the updated IMC Prosperity 4 format. These logs can be used directly with [@kevin-fu1's](https://github.com/kevin-fu1) [open-source visualizer](https://kevin-fu1.github.io/imc-prosperity-4-visualizer/). Supports direct visualizer launch in WSL environments.
...
- Round 0 (tutorial): prices and anonymized trades data on `EMERALDS` and `TOMATOES` that was used during tutorial submission runs. The anonymized trades data is derived from the submission of an algorithm that places no orders.
- Round 1: prices and anonymized trades data on `ASH_COATED_OSMIUM` and `INTARIAN_PEPPER_ROOT`.
